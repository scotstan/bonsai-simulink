...
classdef ExportedBrainClient
    ...
    methods
        ...
        function obj = ExportedBrainClient(config)
            obj.config = config;
            obj.logger = bonsai.Logger('ExportedBrainClient', config.verbose);
           
        end

        function r = makeRequest(obj, data, method, endpoint)

            urlString = obj.config.exportedBrainUrl;
